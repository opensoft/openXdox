...
maintainers, either publicly through this project's issue tracker at
[opensoft/openXdox](https://github.com/opensoft/openXdox/issues), or
privately through the reporting path described in
[SECURITY.md](SECURITY.md) when the report itself should not be public.
